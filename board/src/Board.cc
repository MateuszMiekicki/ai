...
bool shakashaka::board::Board::isInRangeOfBoard(
...
bool shakashaka::board::Board::isSettable(const Cell &cell,
                                          const Coordinate &coordinate) const
{
...
shakashaka::board::Cell shakashaka::board::Board::getCell(
    const Coordinate &coordinate) const
{
...
bool shakashaka::board::Board::setCell(const Cell &cell,
...
shakashaka::board::Board::corners_t shakashaka::board::Board::
    getCornersCoordinates() const
{
